...
BACKUP_APP="/var/backups/crm-al-tokens-pre-stage11-1-${STAMP}"
BACKUP_DB="/var/backups/crm-al-gateway-db-pre-stage11-1-${STAMP}.sql"
BACKUP_PM2="/var/backups/pm2-dump-pre-stage11-1-${STAMP}.json"
BACKUP_NGINX="/var/backups/nginx-crm-al-pre-stage11-1-${STAMP}.conf"
PORT="${PORT:-3075}"
TARBALL="${1:-/tmp/stage-11-1-deploy.tgz}"
